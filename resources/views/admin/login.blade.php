                                            ...
                                            <div class="carousel-inner">
                                                <div class="carousel-item active">
                                                    <div class="testi-contain text-white">
                                                        ...
                                                        <h4 class="mt-4 fw-medium lh-base text-white">“Rara Cookies bukan hanya rasa,
                                                            ia adalah perasaan.
                                                            Setiap remahnya membawa kenangan,
                                                            setiap manisnya membangkitkan semangat.
                                                ...
                                                <div class="carousel-item">
                                                    <div class="testi-contain text-white">
                                                        ...
                                                        <h4 class="mt-4 fw-medium lh-base text-white">“Hidup terlalu singkat untuk camilan yang membosankan!
                                                            Rara Cookies hadir dengan kejutan di setiap gigitan.
                                                            Manis, renyah, dan penuh semangat—
                                                            teman setia di hari sibuk dan saat santai.”</h4>
                                                        <div class="mt-4 pt-3 pb-5">
                                                            <div class="d-flex align-items-start">
                                                                <div class="flex-shrink-0">
                                                ...
                                                <div class="carousel-item">
                                                    <div class="testi-contain text-white">
                                                        ...
                                                        <h4 class="mt-4 fw-medium lh-base text-white">“Setiap adonan Rara Cookies
                                                            ...
                                                            untuk merasa semuanya akan baik-baik saja.”</h4>
                                                        <div class="mt-4 pt-3 pb-5">
                                                            <div class="d-flex align-items-start">
                                                                <img src="{{asset('backend/assets/images/users/avatar-3.jpg')}}"
                                                                    class="avatar-md img-fluid rounded-circle" alt="...">
                                                                <div class="flex-1 ms-3 mb-4">
                                                                    <h5 class="font-size-18 text-white">Moh.Rivan Nurdiansyah</h5>
