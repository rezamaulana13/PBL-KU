...
<style>
    /* Styling Kustom untuk Daftar Pesanan */
    .card {
        border-radius: 12px;
    ...
    .card-header-custom {
        ...
        border-bottom: 3px solid #ffc107; /* Garis bawah kuning/warning untuk Pending */
    ...
    .dataTables_wrapper .row:first-child {
        padding-top: 15px; /* Memberi ruang di atas tabel */
    }
</style>
            ...
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between mb-4">
                    <h4 class="mb-sm-0 font-size-18 fw-bold text-dark">
                        <i class="ri-history-line me-2 text-warning"></i> Daftar Pesanan Pending
                    </h4>
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-header card-header-custom">
                        <h5 class="mb-0 text-dark">Total **{{ count($allData) }}** Pesanan Menunggu Konfirmasi</h5>
                    </div>
                        ...
                        <table id="datatable" class="table table-bordered dt-responsive nowrap w-100">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    {{-- Menggunakan badge warning untuk pending --}}
                                    <span class="badge badge-status bg-warning text-dark">{{ $item->status }}</span>
                                </td>
