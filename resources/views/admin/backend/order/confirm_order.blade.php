...
<style>
    /* Styling Kustom untuk Daftar Pesanan Dikonfirmasi */
    .card {
        border-radius: 12px;
    ...
    .card-header-custom {
        ...
        border-bottom: 3px solid #17a2b8; /* Garis bawah biru muda/info untuk Confirmed */
            ...
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between mb-4">
                    <h4 class="mb-sm-0 font-size-18 fw-bold text-dark">
                        <i class="ri-check-line me-2 text-info"></i> Daftar Pesanan Dikonfirmasi
                    </h4>
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-header card-header-custom">
                        <h5 class="mb-0 text-dark">Total **{{ count($allData) }}** Pesanan Siap Diproses</h5>
                    </div>
                        ...
                        <table id="datatable" class="table table-bordered dt-responsive nowrap w-100">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    {{-- Menggunakan badge info untuk Confirmed --}}
                                    <span class="badge badge-status bg-info">{{ $item->status }}</span>
                                </td>
