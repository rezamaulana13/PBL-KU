...
<style>
    /* Styling Kustom untuk Daftar Pesanan Diproses */
    .card {
        border-radius: 12px;
    ...
    .card-header-custom {
        ...
        border-bottom: 3px solid #007bff; /* Garis bawah biru/primary untuk Processing */
            ...
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between mb-4">
                    <h4 class="mb-sm-0 font-size-18 fw-bold text-dark">
                        <i class="ri-loader-4-line me-2 text-primary"></i> Daftar Pesanan Diproses
                    </h4>
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-header card-header-custom">
                        <h5 class="mb-0 text-dark">Total **{{ count($allData) }}** Pesanan Sedang Disiapkan</h5>
                    </div>
                        ...
                        <table id="datatable" class="table table-bordered dt-responsive nowrap w-100">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    {{-- Menggunakan badge primary untuk Processing --}}
                                    <span class="badge badge-status bg-primary">{{ $item->status }}</span>
                                </td>
