                ...
                <div class="gold-members p-4">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h6 class="mb-1 text-black">Beranda</h6>
                            <p class="text-black">
                                {{ $profileData->address }}
                            </p>
...
<script type="text/javascript">
   ...
   var stripe = Stripe('pk_test_51QRCFaGbu7uS4hyTUSV1M9Q1c3wWDcYW9R709lEJYGKsF1anL0lceq6mT9XgSA9oRewyQsv9qo27jarDl90mgYzz00shcdFOs0');
