<nav class="navbar navbar-expand-lg navbar-light bg-light osahan-nav shadow-sm">
    <div class="container">
       <a class="navbar-brand" href="{{ route('index') }}"><img alt="logo" src="{{ asset('frontend/img/logorara.png') }}" width="80"></a>
       ...
       <div class="collapse navbar-collapse" id="navbarNavDropdown">
          <ul class="navbar-nav ml-auto">
             ...
             <li class="nav-item">
                <a class="nav-link" href="offers.html"><i class="icofont-sale-discount"></i> Promo <span class="badge badge-danger">Terbaru</span></a>
             </li>
