    ...
    <div class="container">
       ...
       <div class="collapse navbar-collapse" id="navbarNavDropdown">
          <ul class="navbar-nav ml-auto">
             ...
             <li class="nav-item">
                <a class="nav-link" href="offers.html"><i class="icofont-sale-discount"></i> Promo <span class="badge badge-warning">Terbaru</span></a>
             </li>
             <li class="nav-item dropdown">
                <a class="nav-link" href="{{ route('list.restaurant') }}" role="button" aria-haspopup="true" aria-expanded="false">Produk</a>
             </li>
             @auth
             @php
             $id = Auth::user()->id;
...
Pesanan             <span class="badge badge-success">{{ count((array) session('cart')) }}</span>
             </a>
