                                ...
                                <div class="d-flex align-items-start mt-3 mt-sm-0">
                                    <div class="flex-shrink-0">
                                        <div class="avatar-xl me-3">
                                            <img src="{{(!empty($profileData->photo)) ? url
                                            ('upload/client_images/'.$profileData->photo) :
                                            url('upload/profile.jpg')}}" alt="" class="img-fluid rounded-circle d-block">
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div>
                                ...
                                <img id="showImage" src="{{ (!empty($profileData->cover_photo)) ? url('upload/client_images/'.$profileData->cover_photo) : url('upload/profile.jpg') }}" alt="" class="p-1 bg-primary" width="210" height="100">
                        ...
                        <div class="col-lg-6">
                            <div class="mt-3 mt-lg-0">
                             <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        <label for="example-text-input" class="form-label">Ganti Foto</label>
                                        <input class="form-control" name ="photo" type="file" id="image">
                                    </div>
                                    <div class="mb-3">

                                        <img id="showImage" src="{{(!empty($profileData->photo)) ? url
                                        ('upload/client_images/'.$profileData->photo) :
